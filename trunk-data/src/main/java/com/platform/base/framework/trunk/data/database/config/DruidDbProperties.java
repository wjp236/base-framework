package com.platform.base.framework.trunk.data.database.config;
...
@Component
@ConfigurationProperties(prefix = DruidDbProperties.PREFIX)
public class DruidDbProperties implements BeanClassLoaderAware {
	...
	private String basePackage = "com.platform.product.*.repository.jdbc";
